...
# ``SKYGREP_SYMBOL_WEIGHT`` env var so the integrator can sweep it without
# touching code.
SYMBOL_WEIGHT = float(os.environ.get("SKYGREP_SYMBOL_WEIGHT", "0.10"))
...
TIEBREAK_EPS = float(os.environ.get("SKYGREP_TIEBREAK_EPS", "0.005"))
GRAPH_TIEBREAK_WEIGHT = float(
    os.environ.get("SKYGREP_GRAPH_TIEBREAK_WEIGHT", "0.005")
)
