# local-mgrep 0.16.0 — release notes
...
free, while companies that want to embed local-mgrep in commercial
...
## Files changed
  ...
  - `docs/assets/hero-dark.svg` — "MIT" → "PolyForm-NC-1.0.0";
    version stamp.
  - `docs/local-mgrep-0.16.0.md` (this file).
...
If you are using local-mgrep in a commercial context and want to
