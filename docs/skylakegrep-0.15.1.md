# skylakegrep 0.15.1 — release notes
...
Running `skygrep "where is eb1b file?"` in a directory where Word is
...
## Files changed
  ...
  - `skylakegrep/src/auto_index.py`: filename_shortcut find command
    excludes 5 lock/swap/backup naming conventions.
  - `skylakegrep/src/binary_extract.py`: `extract_docx` recognises
  ...
  - `docs/skylakegrep-0.15.1.md` (this file).
...
Before (v0.15.0):
```
$ skygrep "where is eb1b file?" -m 10
... 5 EB1B PDFs ...
